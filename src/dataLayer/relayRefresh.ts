 ...
 * in-memory interests (common when Android/Capacitor suspends the WebView).
 *
 * Reactive consumers (FileIndexProvider, avatar/server observers) read this via
 * `useSyncExternalStore` and re-declare their interest when it changes, which
